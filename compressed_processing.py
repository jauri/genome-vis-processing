...
def createBlock(idx, score, numberAligned, segList, maxLength):
    return {'id': idx, 'score': score, 'numberAligned': numberAligned, 'segList': segList, "maxLength": maxLength, "compressedNextTo": 0, "compressedStart": 0, "neighborOrder": 0}
...
#------input parameters
runName = "ecoli"
mafFileName = "twenty_five_ecoli.maf"#"inputData/seven_ecoli.maf" #"inputData/aBaumannii.maf" #"inputData/EcoliMugsyOut2.maf"
f = open( mafFileName)
